        ...
        <div class="container">
            <div class="col-xs-12 no-margin">
                ...
                <section id="shipping-address">
                    ...
                    <div class="row field-row parent" id="<?=$value['address_id'];?>">
                        ...
                        <div class="col-xs-12 col-sm-2">
                            <div class="radio-label bold " >
                                <a href="<?= \yii\helpers\Url::to(['order/update','id'=>$value['address_id']])?>">修改</a>
                                <span class="glyphicon glyphicon-remove del" aria-hidden="true"></span>
                            </div>
                        </div>
                    </div><!-- /.field-row -->
                ...
                <a href="<?= \yii\helpers\Url::toRoute(['order/consignee'])?>">添加新地址</a>
